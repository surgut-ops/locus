...
import {
  ...
  ListingMediaStorage,
} from '../../modules/listing-media/media.service.js';
import type { ListingImageProcessingPayload } from '../../modules/listing-media/media.types.js';
...
async function processImageJob(job: Job<ListingImageProcessingPayload>) {
  ...
  logger.info('Processing image optimization and thumbnail', {
